...
class SystemCommandExecutor {
    ...
    SystemCommandExecutor(String[] commandInformation) {
        this(Arrays.asList(commandInformation));
    }
     ...
     */
    SystemCommandExecutor(List<String> commandInformation) {
        if (commandInformation == null)
            throw new NullPointerException("The commandInformation is required.");
        this.commandInformation = commandInformation;
    }

    int executeCommand() throws Exception {
        int exitValue = -99;
    ...
    List<String> getStandardOutputStream() {
        return inputStreamHandler.getOutputBufferList();
    }
